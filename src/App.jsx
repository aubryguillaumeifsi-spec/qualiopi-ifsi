...
function MainApp() {
  ...
  const handleChangeUserIfsi = async (userId, ifsiId) => { await updateDoc(doc(db, "users", userId), { etablissementId: ifsiId }); };
