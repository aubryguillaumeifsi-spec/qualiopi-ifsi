    ...
    <div className="animate-fade-in" style={{ display:"flex", flexDirection:"column", gap:"16px", height:"100%" }}>
        ...
        {[
          ...
          return (
            <div key={s.id} onClick={() => setFilterStatut(isActive ? "tous" : s.id)} className="stat-card" style={{ background: isActive ? s.bg : t.surface, borderColor: isActive ? s.bd : t.border, borderRadius:"10px", padding:"16px 20px", display:"flex", justifyContent:"space-between", alignItems:"center", boxShadow: isActive ? t.shadowMd : t.shadowSm }}>
              ...
              <div style={{ width:"12px", height:"12px", borderRadius:"50%", background:s.c, boxShadow:`0 0 8px ${s.bd}` }}/>
            </div>
          );
        })}
      </div>
      ...
      {vue === "table" && (
        <div style={{ background:t.surface, border:`1px solid ${t.border}`, borderRadius:"10px", overflow:"visible", boxShadow:t.shadowSm, flex:1, display:"flex", flexDirection:"column" }}>
          <div style={{ display:"grid", gridTemplateColumns:"60px minmax(0, 1fr) 110px 110px 60px", padding:"8px 24px", background:t.surface2, borderBottom:`1px solid ${t.border}` }}>
          ...
          <div style={{ paddingBottom:"10px" }}>
            {filtered.length === 0 ? (
              ...
              filtered.map(c => {
                 ...
                 return (
                   <div key={c.id} className="ro" onClick={() => setModalCritere(c)} style={{ display:"grid", gridTemplateColumns:"60px minmax(0, 1fr) 110px 110px 60px", alignItems:"center", gap:"12px", padding:"10px 24px", borderBottom:`1px solid ${t.border2}` }}>
                      <span style={{ fontSize:"13px", fontWeight:"800", color:cConf.color, fontFamily:"'Albert Sans',sans-serif" }}>
                        {c.num}
                      </span>
                      <span style={{ fontSize:"12px", color:t.text, paddingRight:"16px", fontWeight:"500", whiteSpace:"nowrap", overflow:"hidden", textOverflow:"ellipsis" }}>
                        {c.titre}
                      </span>
                      <div>
                      ...
                      <span style={{ fontSize:"11px", fontWeight:"700", color: d < 0 && c.statut !== "conforme" && c.statut !== "non-concerne" ? t.red : t.text3, fontFamily:"'DM Mono',monospace", textAlign:"right" }}>
          ...
          {[1,2,3,4,5,6,7].map(num => {
            ...
            return (
              <div key={num} style={{ background:t.surface2, border:`1px solid ${t.border}`, borderRadius:"12px", padding:"20px", boxShadow:t.shadowSm }}>
                {/* En-tête du Critère - Carré arrondi C1/C2 */}
                         ...
                         <div key={c.id} onClick={()=>setModalCritere(c)} className="stat-card" style={{ background:t.surface, border:`1px solid ${t.border}`, borderRadius:"8px", padding:"14px", display:"flex", flexDirection:"column", justifyContent:"space-between", boxShadow:t.shadowSm }}>
                            <div>
                              <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", marginBottom:"10px" }}>
                                 ...
                                 <span style={{ background:themeStatut.bg, border:`1px solid ${themeStatut.bd}`, color:themeStatut.c, fontSize:"9px", fontWeight:"800", padding:"3px 8px", borderRadius:"4px" }}>{labelStatut}</span>
                              </div>
